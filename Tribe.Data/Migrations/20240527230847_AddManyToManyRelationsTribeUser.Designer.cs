...
namespace Tribe.Data.Migrations
{
    ...
    [Migration("20240527230847_AddManyToManyRelationsTribeUser")]
    partial class AddManyToManyRelationsTribeUser
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Tribe.Domain.Models.Task.Task", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("TribeParticipant", b =>
                {
                    ...
                    b.HasKey("ApplicationUserId", "TribeId");

                    b.HasIndex("TribeId");

                    b.ToTable("TribeParticipant");
                });
            ...
            modelBuilder.Entity("Tribe.Domain.Models.Task.Task", b =>
                {
                    ...
                    b.HasOne("Tribe.Domain.Models.User.ApplicationUser", "Performer")
                        .WithMany()
